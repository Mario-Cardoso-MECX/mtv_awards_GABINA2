                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li class="active"><a href="./resultados.php">Lo Más Top</a></li> </ul>
                                        ...
                                        <?php if (isset($_SESSION["nickname"])): ?>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="userDropdown">
                                                    ...
                                                    if ($rol == 128) { 
                                                        echo '<a class="dropdown-item text-dark" href="../panel/dashboard.php">Ir al Panel</a>';
                                                    } elseif ($rol == 85) { 
                                                        echo '<a class="dropdown-item text-dark" href="../panel/dashboard_artista.php">Ir al Panel</a>';
                                                    }
                                                    ?>
