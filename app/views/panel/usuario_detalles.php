                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form id="form-usuario" action="../../backend/panel/update_user.php" method="post"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="id_usuario" class="form-control" id="id_usuario"
                                            placeholder="Nombre(s)" value="<?= $usuario->id_usuario ?>">

                                        <input type="hidden" name="perfil_aterior" class="form-control"
                                            id="perfil_aterior" placeholder="Nombre(s)"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nombre" class="form-control" id="nombre"
                                                        placeholder="Nombre(s)" value="<?= $usuario->nombre_usuario ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
